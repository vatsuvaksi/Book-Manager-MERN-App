...
const userSchema = new mongoose.Schema({
  //Schema is the representation of the Model how we want the data and we can set different constraints through the same
  name: {
    type: String,
    required: true,
  },
...
userSchema.pre("save", async function (next) {
  //.pre Function is used to  modify the value before the schema is implemented
...
//Verifying password here by decrypting and matching with the current instance 
